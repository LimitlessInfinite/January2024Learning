...
document.write('<div class="separator">Task 7</div>')

function ulTripleLi (text,count) {
...
document.write('<div class="separator">Task 8</div>')

let arrayPrimitives = [1,"Test",true,2,"Desktop",false,3,"Linux"]

function listPrimitives (array) {
    document.write('<div><ul>')
    for (let i = 0; i < array.length; i++) {
